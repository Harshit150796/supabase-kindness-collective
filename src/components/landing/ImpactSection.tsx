...
const stats = [
  ...
  { icon: Users, value: '20', label: 'Families Supported', sublabel: 'Across the United States' },
  { icon: Globe, value: '6', label: 'Available Retailers', sublabel: 'Digital voucher networks' },
