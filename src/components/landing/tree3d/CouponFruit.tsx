...
// NOTE: The coupon's full visual (brand, trait, amount, "GROCERY COUPON" label)
// is rendered into a CanvasTexture by drawCouponTexture(). The previous Drei
// <Html transform> DOM overlay was removed for performance — having 16 React
// iframes composited every frame was the single biggest hero hot-spot.
