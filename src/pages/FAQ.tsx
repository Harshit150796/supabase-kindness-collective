...
const hardcodedFaqs = [
  ...
  { question: 'How are recipients verified?', answer: 'Recipients go through a multi-step verification process that includes income documentation, government ID verification, and optionally, referrals from partner organizations. This ensures donations reach those who truly need them.' },
  ...
  { question: 'How do I know my donation is making an impact?', answer: 'Donors have access to a detailed impact dashboard showing exactly how their contributions are being used, including the number of families helped, categories supported, and geographic distribution.' },
  { question: 'Is my personal information secure?', answer: 'Absolutely. We use bank-level encryption and never share personal information. Recipient identities are protected - donors see impact metrics without personal details.' },
